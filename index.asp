...
<head>
  ...
  <!-IE7 mode->
    ...
    <title></title>
    <link href="/Cuscss/login.css?202406291158020553184798" media="all" rel="stylesheet" />
    <link href="/Cuscss/english/frame.css?202406291158020553184798" media="all" rel="stylesheet" />
    <script language="JavaScript" src="/resource/common/md5.js?202406291158020553184798"></script>
    <script language="JavaScript" src="/resource/common/util.js?202406291158020553184798"></script>
    <style type="text/css">
      #first {
    ...
    <script language="JavaScript" src="/resource/common/RndSecurityFormat.js?202406291158020553184798"></script>
    <script language="JavaScript" src="/resource/common/safelogin.js?202406291158020553184798"></script>
    <script type="text/javascript" src="/resource/common/jquery.min.js?202406291158020553184798"></script>
    <script id="langResource" language="JavaScript" src="/frameaspdes/english/ssmpdes.js?202406291158020553184798"></script>
    <script language="JavaScript" type="text/javascript">
      ...
      var ProductName = 'HG8145V5\x2d12';
      ...
      if (CfgMode.toUpperCase() == 'DVODACOM2WIFI') {
        document.write('<script language="javascript" src="/resource/common/crypto-js.js?202406291158020553184798"><\/script>');
      }
  ...
  <div id="main_wrapper">
    <div id="loginarea">
      <script>
        ...
        } else if ((CfgMode.toUpperCase() == 'GLOBE2') && (TypeWord_com == 'PWD')) {
           document.write('<div id="brandlog" style="display:none;" onclick="FrameModeSubmit();"></div>');
           $("#brandlog").css("background", "url(images/globe-logo.jpg) no-repeat center");
           $("#brandlog").css("background-size", "100%");
           $("#brandlog").css("width", "195PX");
           $("#brandlog").css("height", "100PX");
      ...
      <script>
        if (logo_singtel == true) {
          ...
          } else if ((CfgMode.toUpperCase() == 'AOUNITEL') || ((CfgMode.toUpperCase() == 'GLOBE2') && (TypeWord_com == 'PWD'))) {
        ...
        <div id="loginbuttondiv" class="contentItemlogin">
          <div id="tottablecheckcode" border="0" cellpadding="0" cellspacing="0" width="100%" style="display: none">
            ...
            <div class="contenboxlogin"><input type="button" class="whitebuttonBlueBgcss buttonwidth_237px"
                id="loginbutton2" onClick="LoginSubmit(this.id);" value="" BindText="frame003" /></div>
          </div>
  ...
  <script>
    ...
    if (true != mngttype) {
      ...
      if (true == logo_singtel && TypeWord_com == "COMMON") {
        ...
        $("#copyrightlog").css("background", "url(images/globe-logo.jpg) no-repeat center");
        $("#copyrightlog").css("background-size", "100%");
        $("#copyrightlog").css("width", "143px");
        $("#copyrightlog").css("height", "52px");
        $("#welcomtext").css("margin-top", "110px");
      } else {
        document.getElementById('copyrightlog').style.display = 'block';
      }
