...
Functions in this module operate on a :class:`~crawl4ai.extensions.crawler.engine.Crawler`
...
from crawl4ai.extensions.settings import CLOUD_STORAGE_HOSTS, REQUEST_TIMEOUT
from crawl4ai.extensions.storage import file_content_hash, smart_local_path
