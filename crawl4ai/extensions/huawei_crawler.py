"""
Huawei HG8145V5 web-crawler engine — crawl4ai extension port.

This module is a direct port of ``web_crawler.core.engine.Crawler`` into
the ``crawl4ai.extensions`` namespace.  The class is renamed to
``HuaweiCrawler`` and all internal import paths are rewritten to use
the ``crawl4ai.extensions.*`` sibling modules.

See the original module for full documentation.
"""
