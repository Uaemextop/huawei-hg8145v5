...
Ported from ``web_crawler.config.settings`` into the crawl4ai extension
namespace so that crawl4ai modules can use these values without depending
on the ``web_crawler`` package.
"""
