...
Ported from ``web_crawler.core.storage``.  Fully self-contained with no
``web_crawler`` imports.
"""
...
log = logging.getLogger("crawl4ai.extensions.storage")

# Chunk size for streaming large binary files to disk (512 KiB)
_STREAM_CHUNK = 524288

# ---------------------------------------------------------------------------
# Content-Type → extension mapping (inlined from web_crawler.core.storage)
# ---------------------------------------------------------------------------
